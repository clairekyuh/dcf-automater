...
const marketingLanguage = /\b(?:mission|vision|committed|dedicated|empower|pioneer|revolutioni[sz]|innovati(?:on|ve)|industry-leading|world-class|best-in-class|leading the world|trusted by|force multiplier|breakthrough|with confidence|better than we found|learn more|visit (?:our|the) website)\b/i;
